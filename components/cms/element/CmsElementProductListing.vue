...
<template>
  <div class="cms-element-product-listing">
    ...
    <div class="w-full flex justify-center mt-5" v-if="getTotalPagesCount > 1">
      <SwPagination
      ...
      <div class="">
        <div class="mt-6">
          <div
              ...
              class="p-4 md:p-6 lg:p-8 productListElement grid grid-cols-3 gap-5"
          >
            <SwProductCard
                v-for="product in getElements"
                :key="product.id"
